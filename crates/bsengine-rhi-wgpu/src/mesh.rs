...
pub fn cube_vertices() -> (Vec<Vertex>, Vec<u32>) {
    let v = |pos: [f32; 3], col: [f32; 3], normal: [f32; 3]| Vertex {
        position: pos,
        color: col,
        normal,
    };
    ...
    let vertices = vec![
        // front face (+Z) — red
        v([-0.5, -0.5,  0.5], [1.0, 0.2, 0.2], [ 0.0,  0.0,  1.0]),
        v([ 0.5, -0.5,  0.5], [1.0, 0.2, 0.2], [ 0.0,  0.0,  1.0]),
        v([ 0.5,  0.5,  0.5], [1.0, 0.2, 0.2], [ 0.0,  0.0,  1.0]),
        v([-0.5,  0.5,  0.5], [1.0, 0.2, 0.2], [ 0.0,  0.0,  1.0]),
        // back face (-Z) — green
        v([ 0.5, -0.5, -0.5], [0.2, 1.0, 0.2], [ 0.0,  0.0, -1.0]),
        v([-0.5, -0.5, -0.5], [0.2, 1.0, 0.2], [ 0.0,  0.0, -1.0]),
        v([-0.5,  0.5, -0.5], [0.2, 1.0, 0.2], [ 0.0,  0.0, -1.0]),
        v([ 0.5,  0.5, -0.5], [0.2, 1.0, 0.2], [ 0.0,  0.0, -1.0]),
        // top face (+Y) — blue
        v([-0.5,  0.5,  0.5], [0.2, 0.2, 1.0], [ 0.0,  1.0,  0.0]),
        v([ 0.5,  0.5,  0.5], [0.2, 0.2, 1.0], [ 0.0,  1.0,  0.0]),
        v([ 0.5,  0.5, -0.5], [0.2, 0.2, 1.0], [ 0.0,  1.0,  0.0]),
        v([-0.5,  0.5, -0.5], [0.2, 0.2, 1.0], [ 0.0,  1.0,  0.0]),
        // bottom face (-Y) — yellow
        v([-0.5, -0.5, -0.5], [1.0, 1.0, 0.2], [ 0.0, -1.0,  0.0]),
        v([ 0.5, -0.5, -0.5], [1.0, 1.0, 0.2], [ 0.0, -1.0,  0.0]),
        v([ 0.5, -0.5,  0.5], [1.0, 1.0, 0.2], [ 0.0, -1.0,  0.0]),
        v([-0.5, -0.5,  0.5], [1.0, 1.0, 0.2], [ 0.0, -1.0,  0.0]),
        // right face (+X) — magenta
        v([ 0.5, -0.5,  0.5], [1.0, 0.2, 1.0], [ 1.0,  0.0,  0.0]),
        v([ 0.5, -0.5, -0.5], [1.0, 0.2, 1.0], [ 1.0,  0.0,  0.0]),
        v([ 0.5,  0.5, -0.5], [1.0, 0.2, 1.0], [ 1.0,  0.0,  0.0]),
        v([ 0.5,  0.5,  0.5], [1.0, 0.2, 1.0], [ 1.0,  0.0,  0.0]),
        // left face (-X) — cyan
        v([-0.5, -0.5, -0.5], [0.2, 1.0, 1.0], [-1.0,  0.0,  0.0]),
        v([-0.5, -0.5,  0.5], [0.2, 1.0, 1.0], [-1.0,  0.0,  0.0]),
        v([-0.5,  0.5,  0.5], [0.2, 1.0, 1.0], [-1.0,  0.0,  0.0]),
        v([-0.5,  0.5, -0.5], [0.2, 1.0, 1.0], [-1.0,  0.0,  0.0]),
    ];
